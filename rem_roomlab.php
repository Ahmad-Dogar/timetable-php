...
include_once("refresh_rem_room.php");
...
<head>
    ...
    <title>Inteligence TimeTable Management System - Remaining Rooms</title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Remaining Rooms</li>
                                </ol>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade bd-example-modal-sm" id="resetTable" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" style="text-align:center" role="document">
            ...
            <div class="modal-content">
                ...
                <form method="POST" action="copy_r.php">
