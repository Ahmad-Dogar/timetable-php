                                ...
                                <div class="tab-pane active" id="Add_Data" role="tabpanel">
                                    <div class="p-20">
                                        ...
                                        <div class="basic-form">
                                            <form method="POST" action="professor_saving.php">
                                                <div class="row justify-content-center" style="margin-bottom: -15px">
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <input list="names" class="form-control form-control-md "
                                                                name="name" placeholder="Professor Name" required>
                                                            <datalist id="names">
                                                                <?php $sql1 = "SELECT DISTINCT name FROM professors";
                                        ...
                                        while ($row = mysqli_fetch_array( $result1,MYSQLI_ASSOC)):; ?>
                                                    ...
                                                    <div class="col-lg-3">
                                                        <div class="form-group">
                                                            <select class="form-control form-control-md"
                                                                ...
                                                                <option value="21:00PM">9:00PM</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="form-group">
                                                            <select class="form-control form-control-md" Name='day'
                                                                required>
                                                    ...
                                                    <!-- <div class="col-lg-4">
                        <a href="javascript:void(0)" class="add-more-teachers float-end btn btn-primary"style="background-color:  #04112B;color: white;padding: 06px 15px;font-size: 20px;">+</a>
                		</div> -->
                                                    <div class="col-lg-1">
                                ...
                                <div class="tab-pane  p-20" id="Upload_File" role="tabpanel">
                                    <form method="post" action="professor_saving.php" enctype="multipart/form-data">
...
// $con = mysqli_connect('localhost', 'root', '', 'userdata');
    ...
    // $q = 'SELECT * FROM professors INNER JOIN program ON professors.class_id = program.id';
    $q = 'SELECT * FROM professors ORDER BY name, day';
...
?>
    ...
    echo "<center>There's nothing in here to see</center>";
}
?>
                                    ...
                                    <div class="form-group">
                                        <select class="form-control form-control-md" Name='to' id='to' required>
                                            ...
                                            <option value="15:00PM">3:00PM</option>
                                                                ...
                                                                <option value="19:00PM">7:00PM</option>
                                                                <option value="20:00PM">8:00PM</option>
                                                                <option value="21:00PM">9:00PM</option>                                        </select>
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <select class="form-control form-control-md" Name='day' id='tday' required>
                                            <option value="">--- Day ---</option>
                                            <option value="monday">Monday</option>
                                            <option value="tuesday">Tuesday</option>
                                            <option value="wednesday">Wednesday</option>
...
$(document).on('click', '.deletepopup', function () {
    ...
    $.ajax({
        type: "GET",
        url: "ajax_professor.php?id2=" + id2,
...
if(res.status == 404) {
    ...
    $('#from').val(res.data.time_from);
    $('#to').val(res.data.time_to);
    $('#tday').val(res.data.day);
