...
<head>
    ...
    <title>Inteligence TimeTable Management System - Rooms</title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Rooms & Labs</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
if(res.status == 404) {
    ...
    var rday_id = $('select').attr('rday');

if(rday_id){
    if ( rday_id == ' ' ||rday_id == '' || empty(rday_id) ) {
        $('#rday').val('');
}
}
