...
while($row = mysqli_fetch_array($rem_professors)) {
		...
		for ($x = $starttime; $x <= $endtime-1; $x++) {
            ...
            $end=($x+1).':00';
   			...
   			mysqli_query($con, "INSERT INTO remaining_professors (name, time_from, time_to, day)VALUES('$name', '$start', '$end', '$R_day')");
    ...
    $i=0;
        ...
        for ($x = $starttime; $x <= $endtime-1; $x++) {
            ...
            mysqli_query($con, "INSERT INTO remaining_professors (name, time_from, time_to, day)VALUES('$name', '$start', '$end', '$day')");
