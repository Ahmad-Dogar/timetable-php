...
include_once("refresh_rem_professors.php");
 ?>
...
<head>
    ...
    <title>Inteligence TimeTable Management System - remaining-professors</title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title">
                                <h1>Remaining Professors Data</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /# column -->
                        ...
                        <div class="page-header">
                            <div class="page-title">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Remaining Professors</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card">
                                <div class="bootstrap-data-table-panel">
                                    <div class="table-responsive">
                                        <button class='btn' style="float: right; margin-left:-150px;background-color:#343957;color:white" data-toggle="modal" data-target="#resetTable"><i class="ti-reload"
                                                        style="color: white"></i> Reset Table</button>

                                        <table id="bootstrap-data-table-export" class="table table-bordered table-striped mt-2">
<?php
...
?>
                    ...
                    <!-- /# row -->
                                        ...
                                        <!-- ResetTable Modal -->
    <div class="modal fade bd-example-modal-sm" id="resetTable" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" style="text-align:center" role="document">
            ...
            <div class="modal-content">
                ...
                <h3 class="pb-1 modal-title w-100 text-center" id="exampleModalLongTitle">Are you sure?</h3>

                <div class="container-fluid">
                    You will not be able to recover the data after reset !!
                </div>

                <div class="py-4 justify-content-center">
                <form method="POST" action="copy_p.php">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <span class="mx-2"></span>
                        <button type='submit' name='resetTable' class='btn btn-danger'>Confirm</button>
                    </form>
                </div>
